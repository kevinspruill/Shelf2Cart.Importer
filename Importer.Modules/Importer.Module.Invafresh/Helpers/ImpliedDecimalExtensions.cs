...
namespace Importer.Module.Invafresh.Helpers
{
    ...
    {
        // Int extensions
        public static decimal ToPrice(this int value) => value / 100m;
        public static decimal ToFixedWeight(this int value, bool useImpliedDecimal = false)
            => useImpliedDecimal ? value / 10m : value;

        public static decimal ToTare(this int value, bool useTwoDigitPrecision = false)
            => useTwoDigitPrecision ? value / 100m : value / 1000m;

        public static decimal ToNutrition(this int value) => value / 10m;
